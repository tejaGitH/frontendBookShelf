...
const Dashboard = () => {
    ...
    if (booksLoading || friendUpdatesLoading || usersLoading) {
        console.log("loading", booksLoading,friendUpdatesLoading,usersLoading);
        console.log("Loading state detected");
        return <div>Loading...</div>;
    }

    if (booksError || friendUpdatesError) {
        console.log("Error state detected", booksError, friendUpdatesError);
        return <div>Error: {booksError?.message || friendUpdatesError?.message}</div>;
    }
